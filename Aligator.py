...
#Version 1.1.1 (Released on Github on 10/30/2017)
...
#46 was added. Please ensure that this line is disabled (#) if you are not using the
#executable.
...
#written below (starts on line 570).
...
def predict(File):
	...
	Barcodesheet = BarcodeFile.get_sheet_by_name(ProteinName)	#sheet for each protein.
...
BarcodeFile.remove_sheet(BarcodeFile.get_sheet_by_name("Sheet"))
